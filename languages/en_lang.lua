Locales["en_lang"] = {
    ...
    paidDeliveryWeb_items = "Items awarded:",
    paidDeliveryWeb_moved = "Moved to train:",
    paidDeliveryWeb_failed = "Failed to award:",
    currencyCash = "Cash",
    currencyGold = "Gold",
    ...
    needItemsForDelivery = "You are missing required items for this delivery mission",
    ...
    movedItemsToTrainHeader = "The following items were placed into your train inventory:",
    ...
    noBoat = "You don't have a train out",
    tooFar = "You're too far from your train",
}
